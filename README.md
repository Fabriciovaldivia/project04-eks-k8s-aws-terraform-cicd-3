# 🚀 Despliegue Automático en AWS EKS con Terraform y GitHub Actions
...
```text
project04-eks-k8s-aws-terraform-cicd-3/
├── .github/workflows/
...
1.  **Conectarse al clúster:**
    ```bash
    aws eks update-kubeconfig --region us-east-1 --name project03-eks
    ```
